/**
 * Montana front-end behaviour, without jQuery.
 *
...
(function () {
  ...
  // The Gijgo datepickers on #datepicker and #datepicker2 were already
  // switched off here; the booking form's CF7 [date] fields are native date
  // inputs.
