                    ...
                    if (b.display_gallery)
                        if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                            ...
                            for (d = 0; d < max; d++) c += "<div class='single_instagram'>", c += "\t<img src='" +
                                a[d].node.thumbnail_src + "' alt='" + b.username + " instagram image " + d + "'" + k + " /><div class='ovrelay'><a href='https://www.instagram.com/p/" + a[d].node.shortcode + "' target='_blank'><i class='fa-brands fa-instagram'></i></a>", c += "</div></div>";
