...
final class Montana {
	...
	private function enqueue() {
		...
		$scripts = array(
			...
			'scripts' => array(
				...
				array(
					'handler'    => 'montana-owl-carousel-js',
				...
				array(
					'handler'    => 'montana-isotope-pkgd-js',
				...
				array(
					'handler'    => 'montana-jquery-slicknav-js',
				...
				array(
					'handler'    => 'montana-jquery-magnific-popup-js',
	...
	public function enqueue_elementor_notice_script(){
		...
		if( $had_elementor == 'no' && self::check_elementor_preview_page() ){
			wp_enqueue_script( 'montana-elementor-notice', MONTANA_DIR_JS_URI.'montana-elementor-notice.js', array('jquery'), '1.0', true );
			wp_localize_script(
