...
// image default alt
if ( ! function_exists( 'montana_img_default_alt' ) ) {
	function montana_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'montana_img_tag' ) ) {
	function montana_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = montana_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'montana_anchor_tag' ) ) {
	function montana_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'montana_heading_tag' ) ) {
	function montana_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'montana_paragraph_tag' ) ) {
	function montana_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'montana_other_tag' ) ) {
	function montana_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'montana_button_element ' ) ) {
	function montana_button_element( array $args ) {
